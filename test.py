...
def test_leave_one_out(patient=0, flair=True, t1=True, full=True, first5=True, aug=True, verbose=False):
    ...
    model_path = 'models/Full_Flair_T1_5_No_Augmentation/'
...
def main():
    result = np.ndarray((60,4), dtype = 'float32')
    
    for patient in range(60):
        dsc, avd, recall, f1 = test_leave_one_out(patient, first5=True, verbose=True)#
